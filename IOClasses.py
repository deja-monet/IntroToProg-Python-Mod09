...
# dejam,220906,edited vocabulary in EmployeeIO class (see EmployeeIO class changeLog)
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    changelog: (When,Who,What)
        ...
        dejam,220906:
            - edited vocabulary in print_current_list_items
            - edited vocabulary in input_employee_data
    """
    @staticmethod
    ...
    def input_employee_data():
        ...
        """
        try:
            employee_id = (input("What is the employee's ID? - ").strip())
            first_name = str(input("What is the employee's first name? - ").strip())
            last_name = str(input("What is the employee's last name? - ").strip())
            print()  # Add an extra line for looks
            
            if(employee_id.isnumeric == False or first_name.isnumeric == True or last_name.isnumeric == True):
