...
# dejam,220907,edited Employee class (see notes in Employee class changeLog)
# ---------------------------------------------------------- #
...
class Employee(Person):  # Inherits from Person
    ...
    changelog: (When,Who,What)
        RRoot,1.1.2030,Created Class
        dejam,220906:
            - see employee_id.setter:
                - edited employee_id to set value as: self.__employee_id = value
                - corrected from: self.__last_name = value
    """
