...
# dejam,220906:
#       - imported DataClasses.py
#       - removed class DatabaseProcessor
# ---------------------------------------------------------- #
if __name__ == "__main__":
    raise Exception("This file is not meant to run by itself!")
else:
    import DataClasses as Data_Classes
...
class FileProcessor:
    ...
    changelog: (When,Who,What)
        ...
        dejam,220906,imported DataClasses module to read Employee data
    """
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            for line in file:
                row = line.split(",")
                row_employee_data = Data_Classes.Employee(row[0], row[1], row[2].strip())
                list_of_rows.append(row_employee_data)
            file.close()
        except Exception as e:
            print("There was a general error!")
            print(e, e.__doc__, type(e), sep='\n')
